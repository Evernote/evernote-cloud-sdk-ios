...
#import <Security/Security.h>
	...
	#define ENSSKeychain_SYNCHRONIZATION_AVAILABLE 1
#endif

#ifdef ENSSKeychain_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, ENSSKeychainQuerySynchronizationMode) {
	ENSSKeychainQuerySynchronizationModeAny,
	ENSSKeychainQuerySynchronizationModeNo,
	ENSSKeychainQuerySynchronizationModeYes
};
#endif
...
@property (nonatomic) ENSSKeychainQuerySynchronizationMode synchronizationMode;
#endif
...
/**
 ...
 ENSSKeychain_SYNCHRONIZATION_AVAILABLE is only for compile time. If you are checking for the presence of synchronization,
